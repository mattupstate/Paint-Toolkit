package 
{
	public class SteeredVehicle extends Vehicle
	{
		...
		protected var _arrivalThreshold:Number = 100;
		protected var _wanderAngle:Number = 0;
		protected var _wanderDistance:Number = 10;
		protected var _wanderRadius:Number = 5;
		protected var _wanderRange:Number = 1;
		protected var _pathIndex:int = 0;
		protected var _pathThreshold:Number = 20;
		protected var _avoidDistance:Number = 300;
		protected var _avoidBuffer:Number = 20;
		protected var _inSightDist:Number = 200;
		protected var _tooCloseDist:Number = 60;
        protected var _hasArrived:Boolean = false;
        ...
        public function get hasArrived():Boolean { return _hasArrived; }
		...
		{
			var center:Vector2D = velocity.clone();
			center.normalize();
			center.multiply(_wanderDistance);
		...
		public function avoid( vehicles:Array ):void
		{
            var i:int = 0;
            var amt:int = vehicles.length;
		    for( i; i < amt; i++)
		    {
		        var circle:Vehicle = Vehicle( vehicles[i] );
